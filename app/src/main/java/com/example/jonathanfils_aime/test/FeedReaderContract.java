...
public class FeedReaderContract {
    ...
    public static class FeedEntry implements BaseColumns
    {
        ...
        public static final String COLUMN_NAME_DOUBLE_CLICK_CHOICE = "double_click_choice";
        public static final String COLUMN_NAME_LONG_PRESS_CLICK_CHOICE = "long_press_click_choice";
