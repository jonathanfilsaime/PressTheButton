...
public class Profile_2 extends AppCompatActivity implements NumberPicker.OnValueChangeListener {
    ...
    public String MOMS_BUTTON = "F022cgX6";
        ...
        first_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id)
            {
                ...
                if(++check > 1)
                {
                    ...
                    button.setCompoundDrawablesWithIntrinsicBounds(reference, R.drawable.single_click, R.drawable.image_three_dollars, 0);
        ...
        second_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (++check > 1) {
                    ...
                    button.setCompoundDrawablesWithIntrinsicBounds(reference, R.drawable.double_click, R.drawable.image_five_dollars, 0);
                }
    ...
    public void show()
    {
        final Dialog d = new Dialog(Profile_2.this);
    ...
    private void setupEventListenerForButtonInActivity(FlicButton button)
    {
        FlicButtonListener listener = new FlicButtonAdapter()
        {
            ...
            public void onButtonSingleOrDoubleClickOrHold(FlicButton button, boolean wasQueued, int timeDiff,
                ...
                if( button.getName().equals(MOMS_BUTTON) ) {
